...
public class player : MonoBehaviour
{
    ...
    public readonly float maxLife = 3;    //最大体力（readonlyは変数の変更ができなくなる）
    public float life = 3;    //現在体力
 ...
 void Update()
        ...
        {
            //体力が2になったら
            Object.Destroy(gameObject.tag == "hp_3");//hp_3を消す
        
        }
        if (life = 1)
        {
            //体力が2になったら
            Object.Destroy(gameObject.tag == "hp_2");//hp_3を消す
